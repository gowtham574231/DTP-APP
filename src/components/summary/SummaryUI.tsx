// src/components/summary/SummaryUI.tsx
...
interface SummaryUIProps {
  ...
  generateDocx: () => void;
  onMerge: () => void; // ✅ ensure this line exists
}
    ...
    <div className="bg-white shadow-md rounded-2xl p-6 max-w-2xl mx-auto mt-6">
      ...
      <div className="flex justify-center gap-4">
        <button
          ...
          className="flex-1 bg-yellow-600 text-white py-2 rounded-lg font-semibold hover:bg-yellow-700 transition-all"
        >
          Generate Word
        </button>
