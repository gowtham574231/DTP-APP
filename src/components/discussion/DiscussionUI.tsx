...
const DiscussionUI: React.FC<Props> = ({
  title,
  setTitle,
  paragraphs,
  setParagraphs,
  ...
  return (
    <div className="bg-gradient-to-b from-yellow-50 to-white shadow-lg rounded-2xl p-8 max-w-3xl mx-auto mt-8 border border-gray-200">
      ...
      <input
        ...
        className="w-full border p-3 mb-5 rounded-lg focus:ring-2 focus:ring-yellow-400"
      />

      {/* Paragraphs */}
      <label className="block mb-2 font-semibold text-gray-700">Paragraphs</label>
      <textarea
        className="w-full border p-3 mb-6 rounded-lg h-48 resize-none focus:ring-2 focus:ring-yellow-400"
        value={paragraphs}
        onChange={(e) => setParagraphs(e.target.value)}
        placeholder="Enter your discussion text..."
      />
